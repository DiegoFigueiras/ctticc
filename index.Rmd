...
+ Simple inputs are "scored" binary item responses: 
  + 1 = correct
  + 0 = incorrect
  
Test administrators then receive *graphical* feedback regarding item performance:
]
...
[![](dashboard.png)](https://diegofigueiras.shinyapps.io/TestItemCharacteristics/)
