...
The visual presentation is most informative when item characteristics are plotted simulataneously:
...
The test administrator receives visual feedback that `item 7` is the easiest, `item 1` is the most difficult, `item 4` and `item 6` are not  discriminating well, and something is "wrong" with `item 3`. 
